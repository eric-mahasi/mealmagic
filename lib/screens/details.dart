      ...
      body: SafeArea(
        child: app.isLoading ? Loading() : Column(
          ...
          children: <Widget>[
            ...
            CustomText(text: widget.product.name,size: 26,weight: FontWeight.bold, color: black,),
            CustomText(text: "\$${widget.product.price / 100}",size: 20,weight: FontWeight.w400,color: black,),
            SizedBox(height: 10,),

            CustomText(text: "Description",size: 18,weight: FontWeight.w400, color: black,),
